...
{for(var i = 0, len = gdjs.Manteigaria_32FimCode.GDfundoObjects2.length ;i < len;++i) {
    gdjs.Manteigaria_32FimCode.GDfundoObjects2[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)));
}
}}
...
{for(var i = 0, len = gdjs.Manteigaria_32FimCode.GDfundoObjects1.length ;i < len;++i) {
    gdjs.Manteigaria_32FimCode.GDfundoObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)) + 4);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("task_confirmation"), gdjs.Manteigaria_32FimCode.GDtask_9595confirmationObjects1);
{for(var i = 0, len = gdjs.Manteigaria_32FimCode.GDtask_9595confirmationObjects1.length ;i < len;++i) {
    gdjs.Manteigaria_32FimCode.GDtask_9595confirmationObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("fundo"), gdjs.Manteigaria_32FimCode.GDfundoObjects1);
{for(var i = 0, len = gdjs.Manteigaria_32FimCode.GDfundoObjects1.length ;i < len;++i) {
    gdjs.Manteigaria_32FimCode.GDfundoObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)));
}
}}
