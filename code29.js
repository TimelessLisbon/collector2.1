...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19516012);
}
...
};gdjs.Percurso_32Belas_32ArtesCode.userFunc0xdbd168 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32Belas_32ArtesCode.userFunc0xdbd1c0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19534796);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19536524);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19538980);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "click-21156.mp3", false, 100, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19545532);
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField(gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), "Score", runtimeScene.getGame().getVariables().getFromIndex(1).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(6));
}}
...
}{runtimeScene.getGame().getVariables().getFromIndex(6).setNumber(runtimeScene.getScene().getVariables().getFromIndex(9).getAsNumber());
...
{for(var i = 0, len = gdjs.Percurso_32Belas_32ArtesCode.GDpercursoObjects1.length ;i < len;++i) {
    gdjs.Percurso_32Belas_32ArtesCode.GDpercursoObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}{for(var i = 0, len = gdjs.Percurso_32Belas_32ArtesCode.GDgmapsObjects1.length ;i < len;++i) {
    gdjs.Percurso_32Belas_32ArtesCode.GDgmapsObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}}
...
gdjs.Percurso_32Belas_32ArtesCode.userFunc0xdbd168(runtimeScene);
...
gdjs.Percurso_32Belas_32ArtesCode.userFunc0xdbd1c0(runtimeScene);
