...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20548772);
}
...
};gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x13c51b0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x13c5220 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20568180);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20569996);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20572452);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "click-21156.mp3", false, 100, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20578828);
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField(gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), "Score", runtimeScene.getGame().getVariables().getFromIndex(1).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(6));
}}
...
gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x13c51b0(runtimeScene);
...
gdjs.Percurso_32Sta_32CatarinaCode.userFunc0x13c5220(runtimeScene);
