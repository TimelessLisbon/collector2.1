...
};gdjs.Percurso_32BrasileiraCode.userFunc0xd51c40 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32BrasileiraCode.userFunc0xd51c98 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
{for(var i = 0, len = gdjs.Percurso_32BrasileiraCode.GDpercursoObjects1.length ;i < len;++i) {
    gdjs.Percurso_32BrasileiraCode.GDpercursoObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}{for(var i = 0, len = gdjs.Percurso_32BrasileiraCode.GDgmapsObjects1.length ;i < len;++i) {
    gdjs.Percurso_32BrasileiraCode.GDgmapsObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}}
...
gdjs.Percurso_32BrasileiraCode.userFunc0xd51c40(runtimeScene);
...
gdjs.Percurso_32BrasileiraCode.userFunc0xd51c98(runtimeScene);
