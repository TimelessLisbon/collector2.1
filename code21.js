...
};gdjs.Percurso_32BicaCode.userFunc0xdbd168 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32BicaCode.userFunc0xdbd1c0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
{for(var i = 0, len = gdjs.Percurso_32BicaCode.GDpercursoObjects1.length ;i < len;++i) {
    gdjs.Percurso_32BicaCode.GDpercursoObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}{for(var i = 0, len = gdjs.Percurso_32BicaCode.GDgmapsObjects1.length ;i < len;++i) {
    gdjs.Percurso_32BicaCode.GDgmapsObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}}
...
gdjs.Percurso_32BicaCode.userFunc0xdbd168(runtimeScene);
...
gdjs.Percurso_32BicaCode.userFunc0xdbd1c0(runtimeScene);
