...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20606284);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20611132);
}
if (isConditionTrue_0) {
...
};gdjs.QR_95Code_95readerCode.asyncCallback20610268 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.QR_95Code_95readerCode.asyncCallback20610268(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20612860);
}
if (isConditionTrue_0) {
