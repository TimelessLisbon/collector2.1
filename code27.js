...
};gdjs.Percurso_32S_46_32CarlosCode.userFunc0xb9de68 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32S_46_32CarlosCode.userFunc0xb9ded8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
{for(var i = 0, len = gdjs.Percurso_32S_46_32CarlosCode.GDpercursoObjects1.length ;i < len;++i) {
    gdjs.Percurso_32S_46_32CarlosCode.GDpercursoObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}{for(var i = 0, len = gdjs.Percurso_32S_46_32CarlosCode.GDgmapsObjects1.length ;i < len;++i) {
    gdjs.Percurso_32S_46_32CarlosCode.GDgmapsObjects1[i].getBehavior("Animation").setAnimationIndex(runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber());
}
}}
...
gdjs.Percurso_32S_46_32CarlosCode.userFunc0xb9de68(runtimeScene);
...
gdjs.Percurso_32S_46_32CarlosCode.userFunc0xb9ded8(runtimeScene);
