...
{for(var i = 0, len = gdjs.Carmo_32EscadasCode.GDfundoObjects2.length ;i < len;++i) {
    gdjs.Carmo_32EscadasCode.GDfundoObjects2[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)));
}
}}
...
{for(var i = 0, len = gdjs.Carmo_32EscadasCode.GDfundoObjects1.length ;i < len;++i) {
    gdjs.Carmo_32EscadasCode.GDfundoObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)) + 4);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("task_confirmation"), gdjs.Carmo_32EscadasCode.GDtask_9595confirmationObjects1);
{for(var i = 0, len = gdjs.Carmo_32EscadasCode.GDtask_9595confirmationObjects1.length ;i < len;++i) {
    gdjs.Carmo_32EscadasCode.GDtask_9595confirmationObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("fundo"), gdjs.Carmo_32EscadasCode.GDfundoObjects1);
{for(var i = 0, len = gdjs.Carmo_32EscadasCode.GDfundoObjects1.length ;i < len;++i) {
    gdjs.Carmo_32EscadasCode.GDfundoObjects1[i].getBehavior("Animation").setAnimationIndex(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(8)));
}
}}
