...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18576988);
}
if (isConditionTrue_0) {
...
};gdjs.Percurso_32Belas_32ArtesCode.userFunc0xc7db28 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32Belas_32ArtesCode.userFunc0xc7db98 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18597300);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18599588);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18602356);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "click-21156.mp3", false, 100, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18613460);
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField(gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), "Score", gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(1)), runtimeScene.getScene().getVariables().get("error"));
}}
...
{runtimeScene.getGame().getVariables().getFromIndex(2).setNumber(29);
    ...
    gdjs.Percurso_32Belas_32ArtesCode.GDnext_9595sceneObjects1[i].setString("Belas Artes - Arrumar");
}
}{for(var i = 0, len = gdjs.Percurso_32Belas_32ArtesCode.GDURLObjects1.length ;i < len;++i) {
    gdjs.Percurso_32Belas_32ArtesCode.GDURLObjects1[i].setString("https://www.google.com/maps/place/38%C2%B042'32.8%22N+9%C2%B008'24.3%22W/@38.7091084,-9.1409319,18z/data=!3m1!4b1!4m4!3m3!8m2!3d38.709107!4d-9.140086?entry=ttu");
}
...
gdjs.Percurso_32Belas_32ArtesCode.userFunc0xc7db28(runtimeScene);
...
gdjs.Percurso_32Belas_32ArtesCode.userFunc0xc7db98(runtimeScene);
